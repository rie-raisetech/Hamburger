...
<main class="l-main">
    <div class="p-card p-card--archive">
        ...
        <div class="c-container p-card__block">
            ...
            <small class="p-card__sub">
                <?php echo esc_html(isset($_GET['s']) ? $_GET['s'] : ''); ?>
            </small>
        </div>
    </div>
    ...
    <?php if (have_posts()) : ?>
        <p class="p-search__results">
            検索結果：<?php echo $wp_query->found_posts; ?>件
        </p>
        <?php while (have_posts()) : the_post(); ?>
            <figure class="c-container p-archive__box">
                <img src="<?php echo get_the_post_thumbnail_url(null, 'full') ?: get_template_directory_uri() . '/images/no_image.jpg'; ?>" alt="<?php the_title(); ?>" class="c-image p-archive__image">
    ...
    <?php else : ?>
        ...
        <p class="p-search__contents">「<?php echo get_search_query(); ?>」に一致する情報は見つかりませんでした。</p>
    <?php endif; ?>
</main>
</article>
